var $ = require('jquery'),
    ...
    Template = require('../templates/add_steel.hbs'),
...
AddSteelView = Marionette.ItemView.extend({
	id : 'add-steel-view',
	tagName : 'div',
	...
	initialize : function(){
		this.collection = new SteelTypes();
		var self = this;
	...
	submitForm : function(){
		...
		var steel_item = new SteelItem(options);
		steel_item.save()
		.done(function(response){
			console.log(response)
		})
